...
import { FiLock, FiMail, FiUser, FiLoader, FiArrowRight, FiAlertCircle,FiCheck, FiX } from 'react-icons/fi';
...
export default function RegisterPage() {
  ...
  const [showToast, setShowToast] = useState<{ show: boolean; message: string; type: 'success' | 'error' }>({ show: false, message: '', type: 'error' });
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      {showToast.show && (
        <div className="fixed top-4 right-4 z-50">
          <div className={`bg-white ${showToast.type === 'success' ? 'text-green-800 border border-green-200' : 'text-red-800 border border-red-200'} px-5 py-4 rounded-xl shadow-xl flex items-start max-w-sm animate-fadeInOut`}>
            ...
            <button
              onClick={() => setShowToast(prev => ({ ...prev, show: false }))}
        ...
        <div className="p-8">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="terms-and-privacy" className="ml-2 block text-sm text-slate-700">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-slate-600">
              ...
              <Link href="/login" className="font-semibold text-blue-600 hover:text-blue-500 transition duration-200">
